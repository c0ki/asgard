...
//                    $loadBalancerDefinition
//                        ->addMethodCall('setBlockedQueryTypes',
//                            array($clientOptions['load_balancer']['blocked_query_types']));
//                }
...
//            }
            //Default endpoint
//            if (isset($clientOptions['default_endpoint'])
//                && isset($endpointReferences[$clientOptions['default_endpoint']])
//            ) {
...
//                $container->getDefinition($clientName)
//                          ->addMethodCall('registerPlugin', array($clientName . '.logger', $logger));
//            }
        }
